...
const redefinicaoSenhalist = require("../../redis/list-redefinir-token");
...
module.exports = {
  ...
  redefinicaoSenha: {
    nome: "Token redefinição senha",
    lista: redefinicaoSenhalist,
    expiricao: [1, "h"],
    cria(id) {
      return criaTokenOpaco(id, this.expiricao, this.lista);
    },
    verifica(token) {
      return verificaTokenOpaco(token, this.nome, this.lista);
    },
